...
import static com.tresende.catalog.infrastructure.genre.GenreRestGateway.GENRE;
import static org.mockito.Mockito.doReturn;

public class GenreRestGatewayTest extends AbstractRestClientTest {
    ...
    public void givenCall_whenCBIsOpen_shouldReturnError() {
        ...
        // then
        assertCircuitBreakerState(GENRE, CircuitBreaker.State.OPEN);
        Assertions.assertEquals(expectedErrorMessage, actualEx.getMessage());
