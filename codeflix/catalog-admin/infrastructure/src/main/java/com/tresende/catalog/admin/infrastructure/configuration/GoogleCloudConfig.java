...
import com.tresende.catalog.admin.infrastructure.configuration.properties.google.GoogleCloudProperties;
...
public class GoogleCloudConfig {
    ...
    @Bean
    @ConfigurationProperties("google.cloud.storage.catalog-admin")
